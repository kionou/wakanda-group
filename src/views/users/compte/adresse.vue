    ...
    <div>
      ...
      <div class="py-2 p-md-2 p-lg-4 bg-white" v-else>
                        <div class="d-flex justify-content-between mb-2 pb-1" style="border-bottom: 1px solid ;">
                           ...
                           <!-- button -->
                           <a href="#" class="btn btn-outline-primary btn-sm" data-bs-toggle="modal" data-bs-target="#addAddressModal">Ajouter une  adresse</a>
                        </div>
                        <div class="row">
                           <!-- col -->
                           <div class="col-xl-5 col-lg-6 col-xxl-4 col-12 mb-4" v-for="adresse in adresseArray" :key="adresse.id">
                              <!-- form -->
                              <div class="card me-2" style="height: 225px;" v-if="adresse?.IsDefault === 1">
                                 <div class="card-body p-6" style="background-color: #ffe70017;">
                                    <p class="mb-2">
                                       {{ adresse?.Prenoms ??  "-" }}   {{ adresse?.Nom ??  "-" }} ,
                                       <br>
                                    <span class="text-muted"> {{ adresse?.ville ??  "-" }} -  {{ adresse?.pays ??  "-" }}</span>   ,
                                       <br>
                                          <span class="text-muted"> {{ adresse?.Whatsapp ??  "-" }},</span>
                                      
                                       <br>
                                       <span class="text-muted"> {{ adresse?.NumerSecondaire ??  "-" }} <strong class="text-dark">(2)</strong>,</span>
                                    </p>
                                 ...
                                 <div class="card-footer d-flex align-items-center justify-content-between">
                                    <button class="btn btn-warning btn-sm text-white" :disabled="adresse.IsDefault === 1" >
                                        Définir par défaut
                                        </button>
                                    <div class="d-flex">
                                       <router-link to="#" class="btn btn-info btn-circle px-3 py-2 me-2" @click="UpdateAdresse(adresse?.id , 'updateAddressModal')">
                                          <span class="text-uppercase small "  :disabled="loadingItems[adresse?.id]">
                                                            <div v-if="loadingItems[adresse?.id]" class="d-flex align-items-center">
                                       ...
                                       <a class="btn btn-primary btn-circle px-3 py-2" href="#"  @click="DeleteAdresse(adresse?.id)"  ><i class="bi bi-trash"></i></a>
                                    </div>
                                 </div>
                              </div>
                              <div class="card me-2" style="height: 225px;" v-else>
                                 ...
                                 <div class="card-footer d-flex align-items-center justify-content-between">
                                    <div class="btn btn-primary btn-sm text-white"  @click="confirm1(adresse?.id)">
                                        Définir par défaut
                                        </div>
                                    <div class="d-flex">
                                       <router-link to="#" class="btn btn-info btn-circle px-3 py-2 me-2" @click="UpdateAdresse(adresse?.id , 'updateAddressModal')">
            ...
            <div class="modal-content">
               ...
               <div class="modal-body p-6">
                  <div class="d-flex justify-content-between mb-5">
                     <div>
                        <!-- heading -->
                        <h5 class="mb-1" id="addAddressModalLabel">Ajouter une adresse</h5>
                  ...
                  <div class="form-container">
                        <div class="row mt-3 content-group">
                            ...
                            <div class="input-groupe me-2">
                                ...
                                <MazInput v-model="step1.Nom" color="warning"
                            ...
                            <div class="input-groupe ">
                                ...
                                <MazInput v-model="step1.Prenoms" color="warning"
                                    name="step1.Prenoms" size="sm" rounded-size="sm"
                                    type="text" />
                                <small v-if="v$.step1.Prenoms.$error">{{  v$.step1.Prenoms.$errors[0].$message  }}</small>
                                    ...
                                    <div class="input-groupe">
                                        <label for="userpassword">
                                           Second numéro  <span class="text-danger">*</span></label>
                                            <MazPhoneNumberInput v-model="step1.NumerSecondaire" size="sm" rounded-size="sm" show-code-on-list color="secondary"
                                                :ignored-countries="['AC']" defaultCountryCode="TG" update="results = $event"
                                                :success="results?.isValid" />
                        ...
                        <div class="col-xl-6">
                                <div class="input-groupe me-2">
                                    <label for="userpassword">
                                        ...
                                        <MazSelect v-model="step1.pays" :options="countriesOptions"   color="secondary"  size="sm" rounded-size="sm"
                                            search   
                                            >
                            ...
                            <div class="col-xl-6">
                                <div class="input-groupe">
                                    ...
                                    <MazInput v-model="step1.ville" color="warning"
                                        name="step1.ville" size="sm" rounded-size="sm" type="text"
                                            />
                    ...
                    <div class="btnForm py-3 d-flex items-center justify-content-center">
                                    <button class="btnLogin btn btn-primary" style="padding: 0.5em 2em !important;" :disabled="isButtonDisabled === true" @click.prevent="SubmitAdresse('addAddressModal')">
                                        <span class="text-uppercase small "  :disabled="loadingItems['addAddressModal']">
                                                            <div v-if="loadingItems['addAddressModal']" class="d-flex align-items-center">
                                                                <LoaderBtn class="loadingbtn"></LoaderBtn>
            ...
            <div class="modal-content">
               ...
               <div class="modal-body p-6">
                  <div class="d-flex justify-content-between mb-5">
                     <div>
                        <!-- heading -->
                        <h5 class="mb-1" id="updateAddressModalLabel">Modifier une adresse</h5>
                        <p class="small mb-0">Add new shipping address for your order delivery.</p>
                     </div>
                     <div>
                        <!-- button -->
                  ...
                  <div class="form-container">
                        <div class="row mt-3 content-group">
                            ...
                            <div class="input-groupe me-2">
                                <label for="userpassword">
                                    Nom <span class="text-danger">*</span></label>
                                <MazInput v-model="step2.Nom" color="warning"
                                    name="step2.Nom" size="sm" rounded-size="sm"
                                    type="text" />
                            ...
                            <div class="input-groupe ">
                                <label for="userpassword">
                                    Prenoms <span class="text-danger">*</span></label>
                                <MazInput v-model="step2.Prenoms" color="warning"
                                    name="step2.Prenoms" size="sm" rounded-size="sm"
                                    type="text" />
                                <small v-if="v$.step2.Prenoms.$error">{{  v$.step2.Prenoms.$errors[0].$message  }}</small>
                                <small v-if="resultError['Prenoms']">{{ resultError["Prenoms"] }}   </small>
                            </div>
                        </div>
                        <div class="col-xl-6">
                                ...
                                <div class="col-xl-6">
                                    <div class="input-groupe">
                                        <label for="userpassword">
                                           Second numéro  <span class="text-danger">*</span></label>
                                            <MazPhoneNumberInput v-model="step2.NumerSecondaire" size="sm" rounded-size="sm" show-code-on-list color="secondary"
                                                :ignored-countries="['AC']" defaultCountryCode="TG" update="results = $event"
                                                :success="results?.isValid" />
                        ...
                        <div class="col-xl-6">
                                <div class="input-groupe me-2">
                                    <label for="userpassword">
                                        Pays <span class="text-danger">*</span></label>
                                        <MazSelect v-model="step2.pays" :options="countriesOptions"   color="secondary"  size="sm" rounded-size="sm"
                                            search   
                                            >
                            ...
                            <div class="col-xl-6">
                                <div class="input-groupe">
                                    <label for="userpassword">
                                        Ville <span class="text-danger">*</span></label>
                                    <MazInput v-model="step2.ville" color="warning"
                                        name="step2.ville" size="sm" rounded-size="sm" type="text"
                                            />
                    ...
                    <div class="btnForm py-3 d-flex items-center justify-content-center">
                                    <button class="btnLogin btn btn-primary" style="padding: 0.5em 2em !important;" :disabled="isButtonDisabled === true" @click.prevent="SubmitUpdateAdresse('updateAddressModal')">
                                        <span class="text-uppercase small "  :disabled="loadingItems['updateAddressModal']">
                                                            <div v-if="loadingItems['updateAddressModal']" class="d-flex align-items-center">
                                                                <LoaderBtn class="loadingbtn"></LoaderBtn>
                                                                <span class="">loading...</span> 
                                                            </div>
                                                            <div v-else>
...
export default {
 ...
 components: {
	   MazPhoneNumberInput , LoaderBtn , SkeletonAdresse
	},
   setup() {
...
try {
const response = await axiosInstance.post('/repertoire-clients' , DataUser, {
   headers: {
      Authorization: `Bearer ${this.loggedInUser.token}`,
   },
...
async UpdateAdresse(id, modalId) {
    ...
    async SubmitUpdateAdresse(modalId){
      ...
      try {
      const response = await axiosInstance.post(`/repertoire-clients/${this.ToId}` , DataUser, {
         headers: {
            Authorization: `Bearer ${this.loggedInUser.token}`,
         },
     ...
     let data = {
      ...
      try {
        const response = await axiosInstance.post(`/repertoire-clients/set-as-default/${id}`, data ,  {
          headers: {
            Authorization: `Bearer ${this.loggedInUser.token}`,
          },
...
async ConfirmeDelete(id) {
    ...
    try {
        const response = await axiosInstance.delete(`/repertoire-clients/${id}`, {
            headers: {
                Authorization: `Bearer ${this.loggedInUser.token}`,
            },
        });
