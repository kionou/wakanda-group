<template>
  <div>
            ...
            <div class="col-xl-8 col-lg-8 col-md-7">
              <div class="card p-4 card-product mb-4" style="width: 100%">
                <div class="row align-items-center" style="width: 100%">
                  <div class="col-xl-11">
                    <h5 class="">
                      <a href="#!" class="text-inherit">Adresse de livraison</a>
                    </h5>
                  ...
                  <div class="col-xl-1 signin">
                    <!-- <span class="d-flex">
                      <i class="bi bi-pen me-1"></i> Changer</span> -->
                  </div>
                </div>
              </div>
              <!-- <Modes></Modes> -->
              <Modes1 :code="adresse?.pays"  @updatePaymentData="handlePaymentData" class="mb-3"></Modes1>
              ...
              <div class="card p-4 card-product mb-4">
                ...
                <div class="mt-2">
                  ...
                  <span class="text-muted"
                    >Livraison dans <span class="text-dark">02 </span> à
                    <span class="text-dark">04 jours</span>
                  </span>
                  <div class="card my-3">
                    <div class="card-header">Point de ralais</div>
                    <div class="card-body text-muted fw-bold">
                      <span class="text-dark"
                        >Agence {{ adresse.relais?.NomPointRelais }} ({{
                          adresse.relais?.Ville
                        }})
                      </span>
                      <br />
                    ...
                    <ul class="list-group list-group-flush card">
                      ...
                      >
                        ...
                        <div class="row align-items-center">
                          <div class="col-6 col-md-6 col-lg-7">
                            <div class="d-flex">
                              <img
                                ...
                                class="icon-shape icon-xxl ms-2"
                              />
                              <div class="ms-3">
                                <!-- title -->
                                <router-link
                          ...
                          >
                            <span class="fw-bold" v-if="item.PrixPromo">{{
                              formatPrice(
                                convertPrice(item?.PrixPromo * item.quantity),
                                selectedDevise?.symbol
                              )
                            }}</span>
                            <span class="fw-bold" v-else>{{
                              formatPrice(
                                convertPrice(item?.Prix * item.quantity),
                                selectedDevise?.symbol
                              )
                            }}</span>
                          </div>
                ...
                <div class="card-body p-6">
                    ...
                    <ul class="list-group list-group-flush">
                      ...
                      >
                        ...
                        <span class="fw-bold"
                          >{{
                            formatPrice(
                              convertPrice(totalWithDiscount),
                              selectedDevise?.symbol
                            )
                          }}
                        </span>
                    ...
                    >
                      ...
                      <div class="col-xl-4 text-end">
                        <button
                          ...
                          :disabled="!code || loadingCoupon || couponApplied"
                        >
                  ...
                  <div class="mb-1 mt-4">
                    ...
                    <router-link to="#" @click="ValiderCommande('valider')">
                      <button
                        class="btn btn-primary d-flex align-items-center w-50"
                        v-if="LoadingItem['valider']"
                        :disabled="LoadingItem['valider']"
                      >
                  ...
                  <div class="col-sm-12">
                    <small class="text-center text-dark row">
                      <div class="col-xl-12">
                        En cliquant sur "Valider", je confirme avoir lu et
                        compris
                      </div>
                      <b class="col-xl-12 text-primary"
                        >Les termes et conditions</b
                      >
                    </small>
                  </div>
                </div>
          ...
          <div class="cart-body">
            <div class="cart-main">
              <div class="cart-empty-group">
                <div
                  class="es--comet-pro-fallback--3ctNGin es--pc--1mZE03B cart-empty-wrap"
                >
                  <img
                    src="@/assets/img/cart.png"
                    class="es--comet-pro-fallback-image--35CZGig es--pc--1mZE03B"
                  />
                  <span
                    class="es--comet-pro-fallback-title--1dzE5qT es--pc--1mZE03B text-center"
                    style="font-size: 16px; padding: 16px 0px"
                    >Pas encore d'articles ? Continuez votre shopping pour en
                    trouver.</span
                  >

                  <div
                    class="es--comet-pro-fallback-button-container--1Tnc92l es--vertical--1KfvoOr"
                  >
                    <router-link to="/" class="btn btn-primary"
                      >Parcourir les articles</router-link
                    >
                  </div>
                </div>
              </div>
    ...
    <div
      ...
      id="delete_product"
      tabindex="-1"
      aria-labelledby="delete_productLabel"
      aria-hidden="true"
    >
      <div
        class="modal-dialog modal-dialog-centered"
        style="max-width: auto !important; width: 100%"
      >
          ...
          <div class="modal-body p-0">
            <div class="comet-v2-modal-content comet-v2-modal-no-header">
              <div class="comet-v2-modal-body comet-v2-confirm modal-left">
                <!-- <div class="comet-v2-confirm-title" >Supprimer l'article</div> -->
                <div class="comet-v2-confirm-content">
                  Êtes-vous sûr(e) de vouloir supprimer cet article ?
                </div>
              </div>
              <div
                class="comet-v2-modal-footer comet-v2-modal-footer-vertical d-flex align-items-center justify-content-center flex-column"
              >
                <button
                  class="comet-v2-btn comet-v2-btn-primary comet-v2-btn-important"
                >
                ...
                <button
                  type="button"
                  class="comet-v2-btn comet-v2-btn-slim comet-v2-btn-important"
                  data-bs-dismiss="modal"
                  aria-label="Close"
                >
                  <span>Annuler</span>
...
import Modes from "@/components/payement/modes.vue";
import Modes1 from "@/components/payement/modes1.vue";
...
export default {
  ...
  this.paymentDataFromChild = data
},
    ...
    async getAdresse() {
      try {
        ...
        if (response.data.status === "success") {
          this.adresse = response?.data?.data?.data?.find(
            (a) => a.IsDefault === 1
          );
    ...
    async applyCoupon() {
      ...
      try {
        ...
        console.error(error);
        this.toast.error(
          "Une erreur s'est produite lors de l'application du code promo.",
          {
            position: "top-right",
            timeout: 2000,
            closeOnClick: true,
    ...
    async ValiderCommande(modalId) {
      ...
      const fullData = {
    ...this.paymentDataFromChild,
 
  }
  console.log('fullData',fullData)

      try {
        const response = await axiosInstance.post("/commandest", data, {
          headers: {
            Authorization: `Bearer ${this.loggedInUser.token}`,
            "Content-Type": "application/json",
          },
