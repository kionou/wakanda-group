    ...
    <div class="sign-header" >
        ...
        <p class="text-center">
            Saisissez votre adresse e-mail ou numéro de téléphone pour vous connecter .
                    ...
                    <div class="form-container">
                        ...
                        <div class="col-12">
                                <div class="input-groupe">
                                    ...
                                    <MazInput v-model="step1.password" color="warning"
                                        name="step1.password" size="sm" rounded-size="sm" type="password"
                                            />
                    ...
                    <div class="btnForm py-3 d-flex items-center justify-content-center">
                                    <button class="btnLogin" style="padding: 0.5em 2em !important;" :disabled="isButtonDisabled" @click.prevent="SubmitLogin('client-login')">
                                        <span class="text-uppercase small "  :disabled="loadingItems['client-login']">
                                                            <div v-if="loadingItems['client-login']" class="d-flex align-items-center">
                ...
                <div class="colsm-12">
                    <small class="text-center text-dark row">
                        <div class="col-xl-12">En continuant, vous acceptez les conditions d'utilisation de Wakanda</div>
        ...
        <div class="d-flex justify-content-center align-items-center flex-column">
          ...
          <p v-if="loadingVerification">
            ...
            redemandez un nouveau code dans <b class="text-primary">{{ formattedTime }}</b>
          </p>
          <div v-else>
          ...
          <ProgressSpinner v-if="loadingVerification" style="width: 50px; height: 50px" strokeWidth="8" fill="transparent"
...
if (response.data.status === "success") {
     this.SendOtpByWhahtsApp(response.data,modalId)
