<template>
  <div>
    ...
    <div v-else>
      <div
        class="row g-4 row-cols-xl-5 row-cols-lg-5 row-cols-2 row-cols-md-2 mt-2"
        v-if="CategoriesArray?.length > 0"
      >
        <div
          class="col"
          v-for="(product, index) in CategoriesArray"
          :key="index"
        >
          <!-- card -->
