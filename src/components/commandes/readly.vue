<template >
    <div>
      <div class="nodata" v-if="CommandesOptions.length === 0">Aucune commande annulée pour le moment  </div>
                              ...
                              <div class="pt-3 px-3">
                                 <div class="row align-items-center">
                                    ...
                                    <div class="col-md-10 col-12 mt-0 d-flex align-items-center">
                                       ...
                                       <span class="badge bg-danger">{{ translateStatus(commande?.StatutCommande)  }}</span>
